  ...
  render() {
    return (
      ...
      <ul id='navbar-wrapper' className='navbar-wrapper' data-test='navbar-wrapper' ref='navbar_wrapper' onChange={this.myFunction}>
        <Link href='/' as={ process.env.ASSET_PREFIX = '/'}><li><a className='name-title i-navbar' >Hello There</a></li></Link>
        <Link href='/' as={ process.env.ASSET_PREFIX = '/'}><li><a className='i-navbar activee' >Home</a></li></Link>
        <Link href='/about' as={ process.env.ASSET_PREFIX = '/about'}><li><a className='i-navbar activee' >About</a></li></Link>
        <Link href='/contact' as={ process.env.ASSET_PREFIX = '/contact'}><li><a className='i-navbar activee' >Contact</a></li></Link>
